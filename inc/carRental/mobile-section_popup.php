<style>
  ...
  .reservation-container .main-content {
    ...
    background: url('./images/car/car mobile.png');
...
<div class="reservation-container">
  <a href="tel:(888) 958-1310">
    <div class="heade">
      <div class="header-title">Car Rental Reservations</div>
      <div class="phone-number">CALL US | 24/7: (888) 958-1310</div>
    </div>
    ...
    <div class="main-content">
      ...
      <div class="content-inner">
        ...
        <div class="promo-banner">
          Speak with Our Car Rental Specialists to Save Up to 40%
        </div>

        <button class="cta-button">
          Call Us Now
          <span class="phone-large">(888) 958-1310</span>
        </button>
      </div>
    </div>
